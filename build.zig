...
pub fn build(b: *std.Build) void {
    ...
    const test_specs = [_]TestSpec{
        ...
        .{ .step = "test-accel-stack", .wrapper = "src/test_root_accel_stack.zig", .desc = "Run stack-only RSF accelerator tests" },
        .{ .step = "test-active-compaction", .wrapper = "src/test_root_active_compaction.zig", .desc = "Run active-row compaction tests" },
